...
def potential_fun(x_ee, x_goal, delta=0.02):
    ...
    # obs center
    obs1= np.array([a[0] + 0.11 + 0.1, a[1]]) 
    Ds1 = 0.2 
    obs2= np.array([a[0] + 0.11 , a[1]+ 0.1])  
    Ds2 = 0.1
    obs3=np.array([a[0] + 0.11 , a[1]- 0.1])
    Ds3 = 0.1
    obs4=np.array([a[0] + 0.11 + 0.05 , a[1]- 0.05]) 
    Ds4 = 0.1
    obs5=np.array([a[0] + 0.11 + 0.05 , a[1]+ 0.05])  
    Ds5 = 0.1
