...
if __name__ == "__main__":
    ...
    p_rival, p_own, p_disk = ([0.0, 0.0], [0.0, 0.6],[0.9, 0.6]) #area [x = 0-1.8, y = 0-1.2]
    ...
    p_own = A_path[-1]
    goal_p = goal_point(p_disk, p_own, step_size = 15, side = 1)
    ...
    plot_path(A_path, B_path, p_attack, goal_p, O, '  (Straight lines)')
    print(p_attack)
    print(A_path)
    # print(phi)
    # print(command)
